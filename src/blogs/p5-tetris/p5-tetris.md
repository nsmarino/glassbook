...
<details>
<summary>Click to see the array of tetromino types</summary>
...
const types = [
  {
    color: 'lightpink',
    shapes: [
      // We will use these strings to calculate the 
      // shape of the tetromino. 'x' represents a block,
      // '.' represents a blank space, and '-' indicates
...
<img src="rendered-tetromino.png" alt="rendered tetromino">
</div>
...
<div className="content-image">
<img src="./dropping-tetromino.gif" alt="rendered tetromino">
</div>
...
<div className="content-image">
<img src="./piling-up.gif" alt="piling up!">
</div>
...
<div className="content-image">
<img src="./stacked-high.png" alt="stacked high!">
</div>
...
<div className="content-image">
  <img src="neatly-arranged.png" alt="neatly arranged, but no way to delete rows">
</div>
...
<div className="content-image">
  <img src="completed-game.gif" alt="The game is now complete and can be played.">
</div>
